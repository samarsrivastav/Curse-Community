...
function AddBanner() {
    return (
        <div className='bg-[#031a27] py-4 my-4'>
            <hr className="w-48 h-1 mx-auto my-4 border-0 rounded md:my-10 " />
            <div className="head text-center">
                <h2 className='text-4xl w-full font-serif text-[#DFF6FF]'>All Your Resourses In One Place</h2>
                <p className='text-md text-white  opacity-50 font-sans'>Welcome to BitByte</p>
            </div>
            <div className="flex sm:flex-col sm:items-center md:flex-row justify-between my-4 mx-auto w-[80%] px-10 ">
